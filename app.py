...
st.set_page_config(page_title="Bengaluru House price predictor",page_icon="icons/house_logo.jpeg",layout="wide")
st.sidebar.subheader("House Price Predictor")
st.sidebar.image("icons/house_logo.jpeg",width=150)
